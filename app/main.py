...
def add_sidebar():
    ...
    #this slider function returns the value for each slider and we are gonna need these values to predict and draw the chart
    #so we will save these values somewhere
...
def main():
    ...
    st.set_page_config(page_title= 'Breast Cancer Predition',
